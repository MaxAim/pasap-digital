...
const Productos = () => {
    return(
        <div className="productos" id="productos">
            ...
            <div>
                <div className="productosImg" id="vacations"><Link to={"/pasap-digital/pasap"} className="productosLinks">Pasaporte<br />Sanitario</Link><Link className="productosOpacity" to={"/pasap-digital/pasap"}/></div>
